...
function remove_taken(courses){
  ...
  function get_user(name) {
    ...
    axios.get('http://ec2-44-196-228-15.compute-1.amazonaws.com:5001/learner/'+name, {
    })
        .then(response => {
...
function check_enrol(user_data){
    ...
    axios.get('http://ec2-44-196-228-15.compute-1.amazonaws.com:5001/enrolDates', {
    })
        .then(response => {
...
function get_courses(user_data){
    ...
    axios.get('http://ec2-44-196-228-15.compute-1.amazonaws.com:5001/courses', {
    })
        .then(response => {
...
function check_application(eligible_length, user_data){
    ...
    notif = 0
    axios.get('http://ec2-44-196-228-15.compute-1.amazonaws.com:5001/applications/'+user_id, {
    })
        .then(response => {
