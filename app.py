...
#         #the question is a weak entity of the quiz
#         quizID = db.Column(db.Integer, primary_key = True)
#         questionNo = db.Column(db.Integer, primary_key=True)
...
#         #to see the which questions are wrong
#         def qResults(self):
#             return self.questionStatus
